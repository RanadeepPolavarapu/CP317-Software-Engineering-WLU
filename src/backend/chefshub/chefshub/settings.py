"""
Django settings for chefshub project.
...
SECRET_KEY = '@9s10ho-zjcmp)g&s14(h69pk1w$c8f57p5*fd3o5x32coev!_'
...
ROOT_URLCONF = 'chefshub.urls'

WSGI_APPLICATION = 'chefshub.wsgi.application'
